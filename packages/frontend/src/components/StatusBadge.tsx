...
const badgeToneClasses: Record<string, string> = {
  ...
  naming_title: 'border-border bg-muted text-muted-foreground',
  building_world: 'border-border bg-muted text-muted-foreground',
  building_outline: 'border-border bg-muted text-muted-foreground',
  planning_chapters: 'border-border bg-muted text-muted-foreground',
  auditing_chapter: 'border-border bg-muted text-muted-foreground',
  revising_chapter: 'border-border bg-muted text-muted-foreground',
  extracting_continuity: 'border-border bg-muted text-muted-foreground',
  extracting_state: 'border-border bg-muted text-muted-foreground',
  checkpoint_review: 'border-border bg-muted text-muted-foreground',
